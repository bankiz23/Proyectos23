...
<head>
  ...
  <title>Inicio de <?php echo $_SESSION['user']; ?></title>
...
<div class="jumbotron text-center">
  <h1>Museo Amparo</h1> 
  <p>Bienvenido(a) <?php echo $_SESSION['user']; ?></p> 
  ...
  <div id="demo" class="collapse">-->
    <form action="formularioVideos.php" class="formulario" method="POST">
      <div class="radio">
        ...
        <label for="presentacion">Presentación de libro</label>
        
        <input type="radio" name="evento" id="rueda" value="rueda">
        <label for="rueda">Rueda de prensa</label>
