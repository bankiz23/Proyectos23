...
<FONT FACE="elvetica">
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="formularioVideos.php">Inicio</a></li>
...
//Hacer la consulta y guardarlo en la variable $resultado.
  ...
  foreach($consulta as $row)
  {
    ...
    $im=$row['Ruta'];
        echo '<br><br><br>';
        echo '<center>'.'<H1>'.$row['Nombre_Video'].'</H1>'.'</center>'.'<br>';
        
        echo "<center><video id='myVideo' controls>
        <source src='../MisVideos/$im' type='video/mp4' audio/mpeg ></video> </center>      
        <br>";
